...
def main():
    ...
    parser.add_argument('-p', '--port', default=1221, type=int, dest='port', help='This options lets you use a custom port instead of 443 (use a port > 1024 to run as non root user)')
